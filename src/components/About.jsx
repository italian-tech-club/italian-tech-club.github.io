...
const Feature = ({ icon: Icon, title, description }) => (
  <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-900 hover:bg-white dark:hover:bg-slate-800 transition-all hover:shadow-xl border border-slate-100 dark:border-slate-800">
    <div className="w-12 h-12 rounded-xl bg-slate-900 dark:bg-white flex items-center justify-center mb-4 text-white dark:text-slate-900">
